    ...
    <>
      ...
      {isShowNews && (
        <EscExit onExit={() => setShowNews(false)}>
          <Dialog open={isShowNews} onOpenChange={setShowNews}>
      ...
      {isShowFeedback && (
        <Dialog open={isShowFeedback} onOpenChange={setShowFeedback}>
          <DialogContent className="sm:max-w-[500px]">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="p-4 space-y-2">
              ...
              <Field>
                ...
                <ShadcnInput name="email" type="email" ref={register} />
              </Field>
            ...
            <DialogFooter className="p-4 pt-0">
              <div className="space-x-3">
                ...
                <ShadcnButton size="sm" type="submit">
                  Send
                </ShadcnButton>
                <ShadcnButton size="sm" onClick={() => handleTweet()}>
                  Tweet it
                  <svg
                    className="ml-1"
                    width="16"
